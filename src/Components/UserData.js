    ...
    <>
      <div className="table" id="results">
        <div className="theader">
          <div className="table_header">ID</div>
          <div className="table_header">FirstName</div>
          <div className="table_header">LastName</div>
        ...
        <div key={user.id} className="table_row">
          ...
          <div className="table_small">
            ...
            <div className="table_cell">
              {user.bank && (
                <>
                  <span>Card Number : {user.bank.cardNumber} ,</span>

                  <span>Card type : {user.bank.cardType} ,</span>
                  <span>Expiry : {user.bank.cardExpire} ,</span>
